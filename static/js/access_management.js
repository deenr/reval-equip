...
function openAddedPictureOfUser(user_id) {
    $.get("/access-files/get-by-user-id?user_id=" + user_id, function (data, status) {
        ...
        picturePopUpHTML = picturePopUpHTML.concat('<div class="picture_pop_up-picture" style="display: block;"><img title="' + picture_name + '" src="static\\images\\upload\\' + picture_name + '"></div>');
